...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsposeimagingCloudApiReference.StorageFile();
  });
  ...
  describe('StorageFile', function() {
    it('should create an instance of StorageFile', function() {
      // uncomment below and update the code to test StorageFile
      //var instance = new AsposeimagingCloudApiReference.StorageFile();
      //expect(instance).to.be.a(AsposeimagingCloudApiReference.StorageFile);
    });
