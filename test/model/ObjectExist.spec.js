...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsposeimagingCloudApiReference.ObjectExist();
  });
  ...
  describe('ObjectExist', function() {
    it('should create an instance of ObjectExist', function() {
      // uncomment below and update the code to test ObjectExist
      //var instance = new AsposeimagingCloudApiReference.ObjectExist();
      //expect(instance).to.be.a(AsposeimagingCloudApiReference.ObjectExist);
    });
