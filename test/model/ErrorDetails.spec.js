...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsposeimagingCloudApiReference.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new AsposeimagingCloudApiReference.ErrorDetails();
      //expect(instance).to.be.a(AsposeimagingCloudApiReference.ErrorDetails);
    });
