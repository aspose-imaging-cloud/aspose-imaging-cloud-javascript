...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsposeimagingCloudApiReference.FileVersion();
  });
  ...
  describe('FileVersion', function() {
    it('should create an instance of FileVersion', function() {
      ...
      //var instance = new AsposeimagingCloudApiReference.FileVersion();
      //expect(instance).to.be.a(AsposeimagingCloudApiReference.FileVersion);
    });
